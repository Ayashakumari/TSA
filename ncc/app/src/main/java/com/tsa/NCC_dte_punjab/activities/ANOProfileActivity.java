...
public class ANOProfileActivity extends CustomActivity {
    ...
    Chunk mTitleChunk[] = new Chunk[14];
    Paragraph mTitleParagraph[] = new Paragraph[14];
    ...
    String titleValus[] = new String[]{
            GLOBAL.anoModel.getInsttName(), GLOBAL.anoModel.getName(), GLOBAL.anoModel.getEmail(),
            GLOBAL.anoModel.getMobile(), GLOBAL.anoModel.getAadhaarNo(), GLOBAL.anoModel.getDob(), GLOBAL.anoModel.getRegistrationNo(),
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ano_profile);
    ...
    private void init() {
        ...
        context = ANOProfileActivity.this;
        ...
        if (GLOBAL.anoModel != null) {
            instituteTv.setText(GLOBAL.anoModel.getInsttName());
            nameTv.setText(GLOBAL.anoModel.getName());
            emailTv.setText(GLOBAL.anoModel.getEmail());
            mobileTv.setText(GLOBAL.anoModel.getMobile());
            aadhaarTv.setText(GLOBAL.anoModel.getAadhaarNo());
            DOBTv.setText(GLOBAL.anoModel.getDob());
            regNoTv.setText(GLOBAL.anoModel.getRegistrationNo());
        }
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checker.lacksPermissions(REQUIRED_PERMISSION)) {
                    PermissionsActivity.startActivityForResult(ANOProfileActivity.this, PERMISSION_REQUEST_CODE, REQUIRED_PERMISSION);
                } else {
